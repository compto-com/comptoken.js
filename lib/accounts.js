 ...
 *
 * @property {() => EnumValues<typeof UserData.VerificationStates>} verificationState
 */
...
class UserData {
    ...
    verificationState() {
        ...
        if (this.verificationDate == 0n) {
            return UserData.VerificationStates.UNVERIFIED;
        } else if (this.verificationDate >= todaySec - UserData.MAX_REVERIFICATION_WAIT) {
