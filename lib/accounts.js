...
const { compto_public_keys, ComptoPublicKeys } = require("./constants.js");
...
class UserDataAccount extends Account {
     ...
     * @returns {PublicKey}
     */
    static addressFromComptokenAccount(comptokenAccountAddress, compto_public_keys = compto_public_keys_) {
