 ...
 */
export async function getComptokenBalance(connection, user_comptoken_token_account_address, commitment = null) {
 ...
 */
export async function getNominalOwner(connection, user_comptoken_token_account_address, commitment = null) {
    const userComptokenAccount = await getComptokenAccount(connection, user_comptoken_token_account_address, commitment);
 ...
 */
export async function getDistributionOwed(connection, user_comptoken_token_account_address, commitment = null) {
    ...
    if (!isVerifiedHuman(connection, user_comptoken_token_account_address, commitment)) {
        ubiOwed = 0;
    }
 ...
 * @returns {Date}
 */
export async function getLastPayoutDate(connection, user_comptoken_token_account_address, commitment = null) {
 ...
 * @throws {TokenError}
 */
export async function getDaysSinceLastPayout(connection, user_comptoken_token_account_address, commitment = null) {
    const user_data = await getUserData(connection, user_comptoken_token_account_address, commitment);
 ...
 * @throws {TokenError}
 */
export async function isVerifiedHuman(connection, user_comptoken_token_account_address, commitment = null) {
 ...
 */
export async function getValidBlockhashes(connection, commitment = null) {
 ...
 */
export async function getHistoricDistributions(connection, commitment = null) {
    const globalData = await getGlobalData(connection);
    return function* () {
