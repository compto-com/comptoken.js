...
class UserDataAccount extends Account {
     ...
     * @returns {PublicKey}
     */
    static addressFromComptokenAccount(comptokenAccountAddress) {
        return PublicKey.findProgramAddressSync([comptokenAccountAddress.toBytes()], compto_program_id_pubkey)[0];
    }
}
