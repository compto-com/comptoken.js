...
//   }
  ...
  console.log('compto_program_id_pubkey:', compto_program_id_pubkey);
  console.log('comptoken_mint_pubkey:', comptoken_mint_pubkey);
  console.log('global_data_account_pubkey:', global_data_account_pubkey);
  console.log('interest_bank_account_pubkey:', interest_bank_account_pubkey);
  console.log('verified_human_ubi_bank_account_pubkey:', verified_human_ubi_bank_account_pubkey);
  console.log('future_ubi_bank_account_pubkey:', future_ubi_bank_account_pubkey);
  console.log('compto_transfer_hook_id_pubkey:', compto_transfer_hook_id_pubkey);
  console.log('compto_extra_account_metas_account_pubkey:', compto_extra_account_metas_account_pubkey);
