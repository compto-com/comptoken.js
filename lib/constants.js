...
const compto_program_id_pubkey = new PublicKey(bs58.decode("C9dX2m6d7RgbtZpy6cKxQetNMx6q7eDSeyDTe1U7JQXr")); // devnet
const comptoken_mint_pubkey = new PublicKey(bs58.decode("7r8jR5xN9aoRvYst2yE3EFDtbrKyZrQ5UsHNx4VFKKLn")); // devnet
const global_data_account_pubkey = new PublicKey(bs58.decode("Fp6fx657xaRhGAEX7FjC33qegGY3wtfNSGtSBXiuGghV")); // devnet
const interest_bank_account_pubkey = new PublicKey(bs58.decode("AqKMqXptg48LbuhahGQFu72DGnPUutSysjX7LtqjgP86")); // devnet
const verified_human_ubi_bank_account_pubkey = new PublicKey(bs58.decode("8a9tWoKd4WPhdK4fVwi4VDx2Q2atMj8TMie548i2u4rv")); // devnet
const future_ubi_bank_account_pubkey = new PublicKey(bs58.decode("GiQwE9gsLggxtVFEgDYwkq3kGYyjFz6EqbZNw6m9HmSm")); // devnet
const compto_transfer_hook_id_pubkey = new PublicKey(bs58.decode("3sMP96YPgiENLoqzLgdH3pFmT34yTssnPGGX2Eg9aFCA")); // devnet
const compto_extra_account_metas_account_pubkey = new PublicKey(bs58.decode("DhDYrtgKJZAauHztk7pPBp8Cf2Na9o7kZr5cZyFUMnmK")); // devnet
