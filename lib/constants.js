...
class ComptoPublicKeys {
    ...
    constructor({
        ...
        this.verified_human_ubi_bank_account_pubkey = verified_human_ubi_bank_account_pubkey ?? PublicKey.findProgramAddressSync([Buffer.from("Verified HumanUBI Bank")], compto_program_id_pubkey)[0];
