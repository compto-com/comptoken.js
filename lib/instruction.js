...
async function collectRequiresUserSignature(connection, user_data_account_address) {
    ...
    const userDataAccount = UserDataAccount.fromAccountInfoBytes(user_data_account_address, accountInfoFixed);
    return userDataAccount.data.verificationState() === UserData.VerificationStates.STALE;
}
